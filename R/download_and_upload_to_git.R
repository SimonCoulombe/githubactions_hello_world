...
# NOTE : when creating github secrets do not add quotes around the keys and regions.
# file.edit(".Renviron")
...
if(FALSE){
  ...
  fake_old_list_of_date_added <- read_csv("https://raw.githubusercontent.com/SimonCoulombe/githubactions_hello_world/main/data/list_of_date_added.csv")
}
